...
const VERSION = '9.9 - Multi-touch'; // バージョン番号を更新
...
const input = {
    joystick: {
        active: false,
        identifier: null, // ★★★ 変更点: ジョイスティックを操作する指を識別 ★★★
        x: 0,
        y: 0,
    },
    touch: {
        active: false,
        identifier: null, // ★★★ 変更点: 視点操作する指を識別 ★★★
        startX: 0,
        startY: 0,
    },
    verticalMove: 0,
...
function setupEventListeners() {
    ...
    // ★★★ 変更点: マルチタッチ対応のため、イベントリスナーを全面的に書き換え ★★★
